...
public static class TownMarketDataGetPricePatch
{
    ...
    private static bool Prefix(EquipmentElement itemRosterElement, MobileParty tradingParty, bool isSelling,
        PartyBase merchantParty, ref int __result)
    {
    ...
    private static void Finalizer(ref int __result, Exception __exception)
    {
